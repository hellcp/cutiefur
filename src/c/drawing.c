...
const int creatures[14][5] = {
    ...
    {RESOURCE_ID_IMAGE_HEDGEHOG_1, RESOURCE_ID_IMAGE_HEDGEHOG_2,
     RESOURCE_ID_IMAGE_HEDGEHOG_3, RESOURCE_ID_IMAGE_HEDGEHOG_4,
     RESOURCE_ID_IMAGE_HEDGEHOG_5},
    {RESOURCE_ID_IMAGE_TURTLE_1, RESOURCE_ID_IMAGE_TURTLE_2, 0,
     RESOURCE_ID_IMAGE_TURTLE_4, RESOURCE_ID_IMAGE_TURTLE_5}};
