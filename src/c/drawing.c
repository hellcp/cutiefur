...
const int creatures[11][5] = {
    ...
    {RESOURCE_ID_IMAGE_FOX_1, RESOURCE_ID_IMAGE_FOX_2,
     RESOURCE_ID_IMAGE_FOX_3, RESOURCE_ID_IMAGE_FOX_4,
     RESOURCE_ID_IMAGE_FOX_5},
    ...
    {RESOURCE_ID_IMAGE_TABBY_1, RESOURCE_ID_IMAGE_TABBY_2,
     0, 0, RESOURCE_ID_IMAGE_TABBY_5},
...
void draw_creature_layer(GContext *ctx, int resource, GColor color, GPoint origin) {
